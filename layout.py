...
def create_layout(update_interval):
    ...
    return html.Div(className="container", children=[
        ...
        html.Div(className="grid", children=[
            ...
            # Right Side - Account Info and Strategy Controls
            html.Div(className="col-4", children=[
                ...
                html.Div(className="card", children=[
                    ...
                    html.Div(className="card-body", style={"padding": "0.75rem"}, children=[
                        ...
                        # Test/Live Mode Toggle (Fixed version using dcc.RadioItems)
                        ...
                        # Strategy Type Selection (Dual Trade vs Fear & Greed)
                        ...
                        # Trading History (Horizontal Box)
                        html.Div(style={"marginTop": "1rem"}, children=[
                            html.H3(className="card-title", style={"fontSize": "0.9rem", "marginBottom": "0.5rem"}, children=[
                                html.I(className="fas fa-history"),
                                html.Span("Trading History")
                            ]),
                            html.Div(id="trade-log", className="log-container")
                        ])
                    ])
                ])
            ])
